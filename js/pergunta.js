...
export const perguntas = [
    ...
    {
        enunciado: "Utilizar uma IA pode ser aterrorizador mesmo, e foi pensando nisso que uma professora de tecnologia da escola decidiu fazer uma sequência de aulas sobre esta tecnologia. No fim de uma aula ela pede que você escreva um trabalho sobre o uso de IA em sala de aula. Qual atitude você toma?",
        alternativas: [
            {
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Tem dificuldade em expressar opiniões muito aprofundadas sobre algum assunto porque tem dificuldade em formulá-las.",
